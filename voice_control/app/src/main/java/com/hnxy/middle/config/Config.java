package com.hnxy.middle.config;
...
public class Config {
     ...
     */
    //TODO 修改app的名称
    private final static String APP_DIR_NAME = "app_gfy";
    // 图片加载库的缓存目录
    ...
    public static String getHostUrl(String key) {
        return HOST + key + VERSION_v100;
    }
    public static final String VERSION_v100 = "v100";

    // 通用接口 V 1.1
    public static String getHostUrl_v1010(String key) {
        return HOST + key + VERSION_v1010;
    }
    public static final String VERSION_v1010 = "v1010";
    ...
    public static final String INVERTER_LIST = "app/statistic/getInverterInfoList/";

    public static final String DEVICE_DETAIL = "app/statistic/getInverterRuningDetailInfo/";

    public static final String ERROR_LIST = "app/statistic/getInverterExceptionInfo/";
    public static final String INVERTER_GENERATION_POWER_INFO = "app/statistic/getInverterGenerationPowerInfo/";
    public static final String INVERTER_OUTPUT_POWER_INFO = "app/statistic/getInverterOutputPowerInfo/";
    /*首页*/
    public static final String HOME = "app/statistic/getStatisticOverView/";
    /*分析*/
    public static final String InverterStatisticInfo = "app/statistic/getInverterStatisticInfo/";
    /*修改密码*/
    public static final String ChangePassword = "/app/auth/updateUserLoginPwd/";
    /*电站统计信息*/
    public static final String PowerStationStatsInfo = "/app/stationstats/getUserPowerStationStatsInfo/";
    /*电站列表*/
    public static final String PowerStationList = "/app/stationstats/getUserPowerStationList/";
    /*检查版本信息*/
    public static final String CheckVersionUpdate = "/app/auth/checkVersionUpdate/";
}