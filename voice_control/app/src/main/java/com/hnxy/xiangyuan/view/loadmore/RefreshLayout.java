package com.hnxy.xiangyuan.view.loadmore;
...
abstract public class RefreshLayout extends FrameLayout {
    ...
    public void completeRefresh(boolean requestSuccess) {
        ...
        if (requestSuccess) {
            if (adapter.getList().isEmpty()) {
                ...
                if (UtilString.isBlank(dataZeroHint)) {
                ...
                if (UtilString.isBlank(dataZerohint2)) {
    ...
    protected void updateList(boolean append, List list, PlusRecyclerAdapter adapter) {
        if (list == null) {
            list = new ArrayList();
        }
